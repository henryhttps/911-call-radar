...
topRightText.onAdd = function () {
  ...
  `;
  div.innerHTML = `
  <a href="../index.html" style="align-items:center; gap:8px; text-decoration:none;">
  <img src="../home_icons/favicon.ico" width="40" height="40" alt="Home" style="image-rendering:pixelated;"></a>
  `;
  return div;
};
